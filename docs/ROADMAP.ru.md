...
|---------|------|--------|------|
| Установщик Windows | `VPS to VPN-Setup.exe` | [скачать](https://github.com/BlackFoxGroup/VPS-to-VPN/releases/latest/download/VPS%20to%20VPN-Setup.exe) | [foxnext.net](https://foxnext.net/downloads/VPS%20to%20VPN-Setup.exe) |
| Portable Windows | `VPS to VPN-Portable.zip` | [скачать](https://github.com/BlackFoxGroup/VPS-to-VPN/releases/latest/download/VPS%20to%20VPN-Portable.zip) | — |
