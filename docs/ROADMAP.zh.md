...
| 产品 | 文件 | GitHub | 网站 |
|------|------|--------|------|
| Windows 安装包 | `VPS to VPN-Setup.exe` | [下载](https://github.com/BlackFoxGroup/VPS-to-VPN/releases/latest/download/VPS.to.VPN-Setup.exe) | [foxnext.net](https://foxnext.net/downloads/VPS%20to%20VPN-Setup.exe) |
